...
(function(global, factory) {
    ...
    Mediator.prototype.publish = function(channelName) {
        // Output Mediator Channel name.
        if (!isNoiseChannel(channelName)) {
            //console.log(' ========== ' + channelName + ' ==========');
        }

        var channel = this.getChannel(channelName || "", true);
        if (channel.namespace !== channelName) {
            //console.log(' (!) NO ONE LISTENS TO THIS EVENT');
            return null;
        }
        ...
        if (!isNoiseChannel(channelName)) {
            // Output args(without last arg, which is channel info).
    ...
    function isNoiseChannel(channelName) {
        return (channelName === "FlowMPM.Chart.HideDynamicTooltip" ||
            channelName === "FlowMPM.Chart.ShowDynamicTooltip" ||
            channelName === "FlowMPM.ProjectFilter.MouseOut" ||
            channelName === "FlowMPM.ProjectFilter.MouseOver" ||
            channelName === "FlowMPM.Chart.UnhighlightProject" ||
            channelName === "FlowMPM.Chart.HighlightProject" ||
            channelName === "FlowMPM.Filter.MouseOver" ||
            channelName === "FlowMPM.Filter.MouseOut");
    }
